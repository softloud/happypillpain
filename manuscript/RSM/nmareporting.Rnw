...
\author{Other co-authors TBC}
\author[2]{Matthew J. Grainger}
...
\jnlcitation{\cname{%
\author{Gray C. T.},
\author{G. Stewart}, and
\author{M. Grainger},
} (\cyear{2021}),
\ctitle{A computational way station for the development of network meta-analysis reporting}, \cjournal{R.S.M}, \cvol{draft}.}
...
\footnotetext{\textbf{Abbreviations} NMA, network meta-analysis; PRISMA, Preferred Reporting Items for Systematic reviews and Meta-Analyses; MECIR, Methodological Expectations of Cochrane Intervention Reviews. Software is referred to as \package{package} by name of R package.}
...
<<r network, message = FALSE, fig.height=5>>=
pain_model <-
