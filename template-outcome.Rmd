...
We will provide an nma **for each outcome**, which adheres to Cochrane's MECIR [@higgins2016] standards for reporting network meta-analyses, in particular, this entails ensuring we meet the thirty-two requirements in the extended PRISMA checklist for network meta-analysis [@hutton2015]. 
...
This is the parameterised report for the outcome:
